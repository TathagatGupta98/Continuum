...
// Signed WAD for the Move contracts, which take `(magnitude: u256, neg: bool)`.
// e.g. μ = −2.5 → { mag: 2_500_000_000_000_000_000n, neg: true }.
export function floatToWadParts(n: number): { mag: bigint; neg: boolean } {
  return { mag: floatToWad(Math.abs(n)), neg: n < 0 }
}
